...
const AvailabilityCard = ({ data }: AvailabilityCardProps) => {
          ...
          <div>
            ...
            <p className="text-muted-foreground text-sm">
              {data?.preferences.location ||
                "Based in India, open to relocation for the right opportunity 🇮🇳"}
            </p>
          </div>
        </div>
            ...
            <div className="text-muted-foreground grid grid-cols-1 gap-y-1 text-sm sm:grid-cols-2">
              <ul className="decoration-none list-disc pl-4">
                {data?.skills.technical
                  ...
                  <>
                    <li>HTML5, CSS3, JavaScript, React, Redux</li>
                    <li>Node.js, Express.js, Next.js, Vite</li>
                    <li>Tailwind CSS, SASS, TypeScript, Chakra</li>
                    <li>Git, REST APIs, Postman</li>
                  </>
                )}
              </ul>
              <ul className="list-disc pl-4">
                {data?.skills.technical
                  ...
                  .map((skill, index) => <li key={index}>{skill}</li>) || (
                  <>
                    <li>Socket.io, React Router, React Hook Form</li>
                    <li>MongoDB , PostgreSQL</li>
                    <li>Vercel, Firebase, Netlify, GitHub</li>
                    <li>PowerShell, Notion</li>
                  </>
                )}
                <li>
                  <a
  ...
  <p className="text-foreground text-sm">
    {data?.experience.internshipCompleted ||
      "Real-world experience in Frontend & Backend development using React.js, Node.js, Express.js, and Next.js."}{" "}
    <br />
    {data?.achievements[0] ||
      "Built and deployed full-stack projects using MongoDB, PostgreSQL, TailwindCSS, and SASS."}{" "}
    <br />
    {data?.experience.freelanceWork ||
      "Experience with platforms & tools like Git, GitHub, Vercel, Netlify, Postman, and Jira for production-ready projects."}
  </p>
</div>
      ...
      <div className="mt-8">
        ...
        <p className="text-foreground text-sm">
          ...
          I want to work on{" "}
          {data?.lookingFor.technicalChallenges || "cutting-edge technologies"}{" "}
          that{" "}
