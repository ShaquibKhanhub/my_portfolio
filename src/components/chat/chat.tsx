...
const Chat = () => {
  ...
  const {
    ...
    onError: (error) => {
      ...
      if (
        ...
        toast.error(
          "⚠️ API Quota Exhausted! Free Gemini API limit reached. Please contact Shaquib directly or use preset questions. Thank you for understanding! 🙏",
          {
        ...
        try {
          append({
            role: "assistant",
            content:
              "⚠️ **API Quota Exhausted**\n\nFree Gemini API limit reached. Please contact Shaquib directly or use preset questions below.",
          });
        } catch (appendError) {
  ...
  "
      ...
      <div className="container mx-auto flex h-full max-w-3xl flex-col ">
                    ...
                    <div className="space-y-4 p-4">
                      ...
                      <div className="text-sm text-amber-800 dark:text-amber-200 space-y-2">
                        <p>
                          ...
                          <strong>free version</strong> of Google's Gemini API,
        ...
        {/* Fixed Bottom Bar */}
        <div className="sticky bottom-0 bg-white px-2 pt-3 md:px-0 dark:bg-black md:pb-4 ">
